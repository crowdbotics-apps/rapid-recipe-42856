"""
Django settings for rapid_recipe_42856 project.
...
ROOT_URLCONF = 'rapid_recipe_42856.urls'
...
WSGI_APPLICATION = 'rapid_recipe_42856.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rapid_recipe_42856 API",
    "DESCRIPTION": "API documentation for rapid_recipe_42856 App",
    "VERSION": "v1",
}
